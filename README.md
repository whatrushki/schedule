...
<img src="https://img.shields.io/badge/version-1.3.3-09090b?style=for-the-badge&labelColor=000000" height="24" />
...
// build.gradle.kts
dependencies {
    implementation("app.what.schedule:core:1.3.3")
    implementation("app.what.schedule:rksi:1.3.3")
    implementation("app.what.schedule:dgtu:1.3.3")
    implementation("app.what.schedule:iubip:1.3.3")
    implementation("app.what.schedule:rinh:1.3.3")
    implementation("app.what.schedule:sfedu:1.3.3")
}
```
